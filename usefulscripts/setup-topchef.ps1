...
function Main {
    ...
    Create-Directory -path $backendDir
    Create-Directory -path $frontendDir
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "package.json") -content $backendPackageJson
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath ".env") -content $backendEnv
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/index.js") -content $backendIndex
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/config/db.js") -content $dbConfig
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/middleware/errorMiddleware.js") -content $errorMiddleware
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/middleware/authMiddleware.js") -content $authMiddleware
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/utils/asyncHandler.js") -content $asyncHandler
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/socket/index.js") -content $socketSetup
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/utils/tokenUtils.js") -content $tokenUtils
...
export default User;
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/models/userModel.js") -content $userModel
...
export default Chef;
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/models/chefModel.js") -content $chefModel
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/models/leagueModel.js") -content $leagueModel
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/models/challengeModel.js") -content $challengeModel
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/models/messageModel.js") -content $messageModel
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/controllers/authController.js") -content $authController
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/controllers/leagueController.js") -content $leagueController
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/controllers/chefController.js") -content $chefController
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/controllers/challengeController.js") -content $challengeController
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/controllers/messageController.js") -content $messageController
...
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/routes/authRoutes.js") -content $authRoutes
...
export default router;
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/routes/leagueRoutes.js") -content $leagueRoutes
...
export default router;
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/routes/chefRoutes.js") -content $chefRoutes
...
export default router;
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/routes/challengeRoutes.js") -content $challengeRoutes
...
export default router;
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath "src/routes/messageRoutes.js") -content $messageRoutes
...
"@
    Create-File -path (Join-Path -Path $rootDir -ChildPath "render.yaml") -content $renderYaml
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "package.json") -content $frontendPackageJson
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "vite.config.js") -content $viteConfig
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "tailwind.config.js") -content $tailwindConfig
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "postcss.config.js") -content $postcssConfig
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "index.html") -content $indexHtml
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath ".env") -content $envFile
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/main.jsx") -content $mainJsx
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/index.css") -content $indexCss
...
export default App;
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/App.jsx") -content $appJsx
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/context/AuthContext.jsx") -content $authContext
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/context/ThemeContext.jsx") -content $themeContext
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/context/SocketContext.jsx") -content $socketContext
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/context/LeagueContext.jsx") -content $leagueContext
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/hooks/useAuth.jsx") -content $useAuth
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/hooks/useTheme.jsx") -content $useTheme
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/hooks/useSocket.jsx") -content $useSocket
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/hooks/useLeague.jsx") -content $useLeague
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/hooks/useChat.jsx") -content $useChat
...
export default api;
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/services/api.js") -content $apiService
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/services/authService.js") -content $authService
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/services/leagueService.js") -content $leagueService
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/services/chefService.js") -content $chefService
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/services/challengeService.js") -content $challengeService
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/services/messageService.js") -content $messageService
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/layouts/MainLayout.jsx") -content $mainLayout
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/layouts/AuthLayout.jsx") -content $authLayout
...
export default Logo;
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/ui/Logo.jsx") -content $logoComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/ui/Button.jsx") -content $buttonComponent
...
export default Card;
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/ui/Card.jsx") -content $cardComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/ui/Input.jsx") -content $inputComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/ui/ThemeToggle.jsx") -content $themeToggleComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/ui/LoadingScreen.jsx") -content $loadingScreenComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/navigation/Sidebar.jsx") -content $sidebarComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/navigation/Header.jsx") -content $headerComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/navigation/MobileNav.jsx") -content $mobileNavComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/chat/ChatPanel.jsx") -content $chatPanelComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/chat/ChatMessage.jsx") -content $chatMessageComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/components/auth/ProtectedRoute.jsx") -content $protectedRouteComponent
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/Login.jsx") -content $loginPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/Register.jsx") -content $registerPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/NotFound.jsx") -content $notFoundPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/Dashboard.jsx") -content $dashboardPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "tsconfig.json") -content $tsConfig
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "tsconfig.node.json") -content $tsConfigNode
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath ".eslintrc.cjs") -content $eslintConfig
...
"@
    Create-File -path (Join-Path -Path $rootDir -ChildPath "README.md") -content $rootReadme
...
*.sw?
"@
    Create-File -path (Join-Path -Path $rootDir -ChildPath ".gitignore") -content $gitignore
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "public/logo.svg") -content $logoSvg
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/ChefRoster.jsx") -content $chefRosterPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/Leagues.jsx") -content $leaguesPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/LeagueDetail.jsx") -content $leagueDetailPage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/Schedule.jsx") -content $schedulePage
...
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath "src/pages/Settings.jsx") -content $settingsPage
...
VITE_SOCKET_URL=http://localhost:5000
"@
    Create-File -path (Join-Path -Path $frontendDir -ChildPath ".env.example") -content $frontendEnvExample
...
CLIENT_URL=http://localhost:5173
"@
    Create-File -path (Join-Path -Path $backendDir -ChildPath ".env.example") -content $backendEnvExample
...
"@
    ...
    if (-not (Test-Path $vscodeDir)) {
        Create-Directory -path $vscodeDir
    }
    Create-File -path (Join-Path -Path $vscodeDir -ChildPath "settings.json") -content $vscodeSettings
...
"@
    Create-File -path (Join-Path -Path $rootDir -ChildPath "start.bat") -content $startBatContent
...
echo "Frontend: http://localhost:5173"
"@
    Create-File -path (Join-Path -Path $rootDir -ChildPath "start.sh") -content $startShContent
